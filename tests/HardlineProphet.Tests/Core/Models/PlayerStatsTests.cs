// tests/HardlineProphet.Tests/Core/Models/PlayerStatsTests.cs
...
public class PlayerStatsTests
{
    ...
    {
        // Arrange
        var stats = new PlayerStats { HackSpeed = 10, Stealth = 5, DataYield = 0 }; // Start with known values
        var item = new Item { Id = "scrambler", Name = "Test Scrambler", Cost = 1, EffectDescription = "+5 Stealth" };
    ...
    {
        // Arrange
        var stats = new PlayerStats { HackSpeed = 20, Stealth = 10, DataYield = 5 }; // Start with known values
        var item = new Item { Id = "accelerator", Name = "Test Accelerator", Cost = 1, EffectDescription = "+10% HackSpeed" };
    ...
    {
        // Arrange
        var stats = new PlayerStats { HackSpeed = 10, Stealth = 10, DataYield = 10 };
        var initialStats = new { stats.HackSpeed, stats.Stealth, stats.DataYield }; // Capture initial values
        var item = new Item { Id = "mystery", Name = "Mystery Meat", Cost = 1, EffectDescription = "??? Profit ???" };
